       ...
       <form method="post" action="salvar.php">
        ...
        <div class ="row mb-3">
            <div class="col-sm-3">
                ...
                <div class="col-sm-4">
                Nº do Cartão SUS: <input type="number" placeholder="000 0000 000 0000" class="form-control form-control-sm" id="cartaoSUS" required>  
                </div>
            <div class="col-sm-3">
        ...
        <div class="row mb-3">
            <div class="col-sm-3">
                Nº CPF: <input type="number" class="form-control form-control-sm" placeholder="000.000.000-00" id="cpf" required>
            </div>  &nbsp  &nbsp
            <div class="col-sm-3">
                Nº RG: <input type="number" class="form-control form-control-sm" placeholder="0000000000-0" id="rg" required>
            </div>  &nbsp  &nbsp
            <div class="col-sm-2">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-3">
            Nº CPF: <input type="number" placeholder="000.000.000-00" class="form-control form-control-sm" id="cpfMAE" required> 
            </div>
            <div class="col-sm-3">
            Celular: <input type="number" placeholder="(00)0000-0000" class="form-control form-control-sm" id="celularMae" idrequired> 
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-3">
            Nº CPF: <input type="number" placeholder="000.000.000-00" class="form-control form-control-sm" id="cpfPAI" required> 
            </div>
            <div class="col-sm-3">
            Celular: <input type="number" placeholder="(00)0000-0000" class="form-control form-control-sm" id="celularPai" required> 
            </div>
        </div>
...
<br>
        <div class="row mb-3">
            ...
            <div class="col-sm-3">
            Nº CPF: <input type="number" placeholder="000.000.000-00" class="form-control form-control-sm" id="cpfResp" required> 
            </div>
            <div class="col-sm-3">
            Celular: <input type="number" placeholder="(00)0000-0000" class="form-control form-control-sm" id="celResp" required> 
            </div>
        </div>
        ...
        <div class="col-sm-3">
            CEP: <input type="number" placeholder="00000-00" class="form-control form-control-sm" id="cep" required> 
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-4">
            Telefone: <input type="number" placeholder="(00)0000-0000" class="form-control form-control-sm" id="tele" required> 
            </div>         
        </div>
    </form>
</div>
